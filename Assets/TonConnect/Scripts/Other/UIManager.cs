...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        getNFTButton = root.Q<Button>("GetNFTButton");

        startButton.clicked += StartButtonPressed;
        exitButton.clicked += ExitButtonPressed;
        getNFTButton.clicked += GetNFTButtonPressed;
    }

    private void GetNFTButtonPressed()
    {
        Debug.Log("Get NFT!");
    }
    ...
    public void ShowConnectModal()
    {
        if (tonConnectHandler.tonConnect.IsConnected)
        {
            ...
            document.rootVisualElement.Q<VisualElement>("Menu").style.display = DisplayStyle.Flex;
        ...
        document.rootVisualElement.Q<VisualElement>("Menu").style.display = DisplayStyle.None;
